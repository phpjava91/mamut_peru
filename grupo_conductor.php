    ...
    <table id='tb' class='display' cellspacing='0' width='100%'>
        ...
        <tbody>
            ...
            if (is_array($objs)):
                foreach ($objs as $o):
                    ?>
                    <tr><td><?php echo $o['id']; ?></td><td><?php echo $o['nombre']; ?></td><td><?php echo $o['descripcion']; ?></td>
